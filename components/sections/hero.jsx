...
export default function Hero({ opacity, scale }) {
  useEffect(() => {
    console.log("-x-x-x");
    console.log(opacity);
  }, [opacity]);
  return (
    <div className="fixed top-0 h-screen min-h-[860px]">
      <section className="relative h-screen min-h-[860px] w-screen">
        {/* hero background */}
        ...
        <motion.div
          ...
          // className="absolute left-[50%] z-10 mt-12 w-[1270px] translate-x-[-50%]"
        >
          <motion.div
            // style={{ opacity: opacity, scale: scale }}
            className="absolute left-[50%] z-10 mt-12 w-[1270px] translate-x-[-50%]"
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="font-jost text-q-wite-almost mt-7 max-w-[496px] text-base font-medium">
                  Nähe zu den Bergen. Die voll ausgestattete 5-Bett-Wohnung
                  liegt direkt am Wanderweg und ist Kinder freundlich
                  eingerichtet. Buchen Sie jetzt Ihren Urlaub in und genießen
                  Sie eine ruhige Lage.
                </p>
              </div>
            </div>
          </motion.div>
          <motion.div
            // style={{ opacity: opacity, scale: scale }}
            className="absolute bottom-0 left-[50%] z-10 mt-18 w-[1270px] translate-x-[-50%]"
          >
            <div className="flex justify-between">
              <div className="flex items-end gap-5 pb-[66px]">
              ...
              <h2 className="font-reem-kufi w-max-[650px text-q-wite-almost pb-[50px] text-right text-[8rem]/32 font-bold tracking-[-6%]">
                <span>Ihr</span>
                <br />
                <span>Urlaub</span>
                <br />

...
function Card({
  ...
  return (
    <>
      <div className="tablet:block tablet:mb-0 mb-10 hidden w-full py-5">
        <div className="flex flex-col">
          ...
          <div className="scrollbar-hide mobile:pl-4 bg-q-card-background mobile:py-2 mb-10 w-screen overflow-x-scroll scroll-smooth py-3 pl-5">
